function scr_save_setting(){
	...
	ini_write_real("control","BACKPACK",ds_control[# 3 , 6]);
	ini_write_real("control","SKILL",ds_control[# 3 , 7]);
	ini_write_real("control","ESCAPE",ds_control[# 3 , 8]);
	ini_write_real("control","SHIFT",ds_control[# 3 , 9]);
	ini_write_real("control","CONTROL",ds_control[# 3 , 10]);
	ini_write_real("control","SPACE",ds_control[# 3 , 11]);
}